...
@interface Session (SWIFT_EXTENSION(Turbolinks))
@end
...
SWIFT_CLASS("_TtC10Turbolinks13VisitableView")
...
@property (nonatomic, strong) NSURL * _Null_unspecified visitableURL;
- (nonnull instancetype)initWithURL:(NSURL * _Nonnull)URL;
@property (nonatomic, strong) VisitableView * _Null_unspecified visitableView;
